...
class AttendeesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attendee" do
    assert_difference("Attendee.count") do
      post attendees_url, params: { attendee: { email: @attendee.email, event_id: @attendee.event_id, name: @attendee.name } }
    end
  ...
  test "should update attendee" do
    patch attendee_url(@attendee), params: { attendee: { email: @attendee.email, event_id: @attendee.event_id, name: @attendee.name } }
